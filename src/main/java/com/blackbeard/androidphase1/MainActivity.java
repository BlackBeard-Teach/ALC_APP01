...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button andela = findViewById(R.id.button_alc_about);
        ...
        Button devInfo = findViewById(R.id.button_dev_info);
        devInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, DevInfo.class);
                startActivity(intent);
            }
        });
    }
